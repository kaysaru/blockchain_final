      ...
      <Grid container spacing={2} align="center" alignItems="center">
        <Grid item xs={5}>
          <Paper elevation={2} sx={{
            ...
            <TextField id="filled-basic" type={"number"} label="Enter AT3 to buy" variant="filled" value={amountAT3}
                       onChange={(e) => setAmountAT3(e.target.value as unknown as number)}/>
            <LoadingButton loading={isETHtoAT3SwapLoading} variant="text" onClick={handleBuy}>Swap</LoadingButton>
        ...
        <Grid item xs={5} sx={{justifyContent: "center"}}>
          <Paper elevation={2} sx={{
            ...
            <TextField id="filled-basic" type={"number"} label="Enter AT3 to sell" variant="filled" value={amountETH}
                       onChange={(e) => setAmountETH(e.target.value as unknown as number)}/>
            <LoadingButton loading={isAT3toETHSwapLoading} variant="text"
                           onClick={() => handleSell(amountETH)}>Swap</LoadingButton>
          </Paper>
        </Grid>
      </Grid>
