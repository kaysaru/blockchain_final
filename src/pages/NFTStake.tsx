        ...
        <Grid container spacing={1} align="center" alignItems="start">
          ...
          <Grid item xs={3}>
            ...
            >
              ...
              <LoadingButton variant="text" loading={isCheckRewardLoading}
          ...
          <Grid item xs={3}>
            ...
            >
              ...
              />
              <LoadingButton loading={isStakeLoading} variant="text" onClick={handleStake}>
                Stake Token
              </LoadingButton>
            </Paper>
          </Grid>
          <Grid item xs={3}>
            ...
            >
              ...
              />
              <LoadingButton loading={isWithdrawLoading} variant="text" onClick={handleWithdraw}>
                Withdraw token
              </LoadingButton>
            </Paper>
          </Grid>
          <Grid item xs={3}>
            ...
            >
              ...
              <LoadingButton loading={isCheckStakedLoading} variant="text" onClick={handleGetStakedTokens}>
                Check staked tokens
              </LoadingButton>
            </Paper>
          </Grid>
